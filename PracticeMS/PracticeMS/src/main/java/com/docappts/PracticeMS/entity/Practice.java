...
public class Practice {
    ...
    String thumbnailPath, Specialty specialty, Billing billing, double billingRate, String email,
    String password, String publicId) {
        this.id = id;
    ...
    public static PracticeDTO generatePracticeDTO(Practice p) {
        ...
        pDTO.setBilling(p.getBilling());
        pDTO.setBillingRate(p.getBillingRate());
        pDTO.setEmail(p.getEmail());
        pDTO.setPassword(p.getPassword());
        pDTO.setPublicId(p.getPublicId());
