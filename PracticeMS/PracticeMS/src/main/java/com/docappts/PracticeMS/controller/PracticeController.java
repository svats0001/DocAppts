...
public class PracticeController {
    ...
    public ResponseEntity<PracticeDTO> getPracticeByPublicId(@PathVariable("publicId") String publicId) throws Exception {
        return ResponseEntity.status(200).body(pService.getPracticeByPublicId(publicId));
    }
    ...
    public ResponseEntity<PracticeDTO> getPracticeByIdSession(@PathVariable("id") int id, @RequestHeader Map<String, String> headers) throws Exception {
        String practiceSessionId = headers.get("practicesessionid");
        return ResponseEntity.status(200).body(pService.getPracticeByIdSession(id, practiceSessionId));
    }
