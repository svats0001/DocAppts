...
public class PractitionerService {
    ...
    public PractitionerDTO getPractitionerByPublicId(String publicId) throws Exception {
        Optional<Practitioner> pOptional = pRepository.findByPublicId(publicId);
        if (pOptional.isPresent()) {
            return Practitioner.convertPractitioner(pOptional.get());
        }
        throw new Exception("Practitioner not found");
    ...
    public PractitionerDTO getPractitionerById(int id) throws Exception {
        Optional<Practitioner> pOptional = pRepository.findById(id);
        if (pOptional.isPresent()) {
            return Practitioner.convertPractitioner(pOptional.get());
        }
