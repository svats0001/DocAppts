...
public class PractitionerController {
    ...
    @GetMapping("{publicId}")
    public ResponseEntity<PractitionerDTO> getPractitionerByPublicId(@PathVariable("publicId") String publicId) throws Exception {
        return ResponseEntity.status(200).body(pService.getPractitionerByPublicId(publicId));
    }
    ...
    @GetMapping("/id/{id}")
    public ResponseEntity<PractitionerDTO> getPractitionerById(@PathVariable("id") int id) throws Exception {
        return ResponseEntity.status(200).body(pService.getPractitionerById(id));
    }
}
