...
export default function TopBar() {
    ...
    return (
        ...
        <><div className="dropdown"><div className="profileImgWrapper"><Image src="/profile_image.jpg" fill style={{objectFit: 'cover'}} alt={"Welcome"} className="dropbtn" onClick={() => togglePracticeDropdown()}></Image></div></div></> :
        <div className="dropdown"><div className="profileImgWrapper"><Image src="/profile_image.jpg" fill style={{objectFit: 'cover'}} alt={"Welcome"} className="dropbtn" onClick={() => togglePracticeDropdown()}></Image></div>
        <div className="dropdown-content">
          <li className="dashboardLink"><b><Link href="/practice/dashboard">Dashboard</Link></b></li>
          <li className="dashboardLink"><b><Link href="/practice/profile">Profile</Link></b></li>
        ...
        <li><b><Link href="/user/history">History</Link></b></li>
