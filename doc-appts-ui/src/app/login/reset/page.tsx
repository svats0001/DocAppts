...
export function LoginReset() {
    ...
    const [errorEmail, formActionEmail, isPendingEmail] = useActionState<RegisterState, FormData>(handleEmailPasswordEdit, initialStateEmail);
    console.log(errorEmail.message);
    ...
    return (
        <div className={styles.loginForm}>
            {errorEmail.message !== "Reset link sent" ?
            <>
            ...
            <p className={styles.errorMessage}>{errorEmail.message}</p>
            </> :
            <>
            <br></br><br></br><br></br>
