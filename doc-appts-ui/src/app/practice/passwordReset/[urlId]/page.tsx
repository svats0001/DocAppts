...
import { getPracticePasswordResetLink, handlePracticePasswordEdit, PracticePasswordReset, RegisterState } from "@/app/lib/actions";
...
export default function Page() {
    ...
    const [errorPassword, formActionPassword, isPendingPassword] = useActionState<RegisterState, FormData>(handlePracticePasswordEdit, initialStatePassword);
