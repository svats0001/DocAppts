...
import { formatDate } from "../appointments/page";
...
function Profile() {
    ...
    const [errorEmail, formActionEmail, isPendingEmail] = useActionState<RegisterState, FormData>(handleEmailEdit, initialStateEmail);
    const initialStateFirstName: RegisterState = {message: null, errors: {}}
    const [errorFirstName, formActionFirstName, isPendingFirstName] = useActionState<RegisterState, FormData>(handleFirstNameEdit, initialStateFirstName);
    const initialStateLastName: RegisterState = {message: null, errors: {}}
    const [errorLastName, formActionLastName, isPendingLastName] = useActionState<RegisterState, FormData>(handleLastNameEdit, initialStateLastName);
    const initialStateDob: RegisterState = {message: null, errors: {}}
    const [errorDob, formActionDob, isPendingDob] = useActionState<RegisterState, FormData>(handleDobEdit, initialStateDob);
    const initialStateGender: RegisterState = {message: null, errors: {}}
    const [errorGender, formActionGender, isPendingGender] = useActionState<RegisterState, FormData>(handleGenderEdit, initialStateGender);
    const initialStateMobile: RegisterState = {message: null, errors: {}}
    const [errorMobile, formActionMobile, isPendingMobile] = useActionState<RegisterState, FormData>(handleMobileEdit, initialStateMobile);
