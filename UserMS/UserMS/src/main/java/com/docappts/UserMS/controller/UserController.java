...
public class UserController {
    ...
    public ResponseEntity<UserDTO> getUserByUserIdPractice(@PathVariable("userId") int userId) throws Exception {
        return ResponseEntity.status(200).body(us.getUserByUserIdPractice(userId));
    }
